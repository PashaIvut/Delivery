...
backend для сервиса доставки. Пользователь регистрируется, оформляет заказ, система ведёт его по статусам и шлёт уведомления. Сейчас это MVP микросервисной архитектуры.
